...
public class Auction extends TimeBaseEntity {
	...
	public static Auction of(User seller, String title, ProductCategory productCategory, int initPrice,
		...
		List<String> imgUrls, String si, String gu, String dong) {
		return Auction.builder()
			.seller(seller)
			.title(title)
			.product(Product.of(status, description, purchaseTime, productCategory, imgUrls))
			.initPrice(initPrice)
			.endDate(endDate)
	...
	public static Auction of(Long id, User seller, String title, ProductCategory productCategory, int initPrice,
		...
		TradeMethod tradeMethod, List<String> imgUrls, String si, String gu, String dong) {
		return new Auction(
			id,
			seller,
			title,
			Product.of(status, description, purchaseTime, productCategory, imgUrls),
			initPrice,
			endDate,
